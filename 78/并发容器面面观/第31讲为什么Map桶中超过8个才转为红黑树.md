...
JDK1.8 的 HashMap 和 ConcurrentHashMap 都有这样一个特点：最开始的 Map 是空的，因为里面没有任何元素，往里放元素时会计算 hash 值，计算之后，第 1 个 value 会首先占用一个桶（也称为槽点）位置，后续如果经过计算发现需要落到同一个桶中，那么便会使用链表的形式往后延长，俗称“拉链法”，如图所示：

![](https://cdn.malinkang.com/images/currency/202112141954343.png)
...
![](https://cdn.malinkang.com/images/currency/202112141955847.png)
...
public class HashMapDemo {
    public static void main(String[] args) {
        HashMap<HashMapDemo,Integer> map = new HashMap<HashMapDemo, Integer>(1);
...
![](https://cdn.malinkang.com/images/currency/202112142002950.png)
