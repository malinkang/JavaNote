...
<img src="https://s0.lgstatic.com/i/image3/M01/85/2C/Cgq2xl6NrzCAEFQ0AB-HOvxO39A990.png" alt="">
...
<img src="https://s0.lgstatic.com/i/image3/M01/85/2C/Cgq2xl6NrzGAMfz3AABHRjw_QSE080.png" alt="">
...
<img src="https://s0.lgstatic.com/i/image3/M01/85/2C/Cgq2xl6NrzGAeQrqAAA0YIeU1Qg392.png" alt="">
...
public class MustDeadLock implements Runnable {
 ...
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  e.printStackTrace()  
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  synchronized (o2) {
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  System.out.println("线程1获得了两把锁")  
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp  if (flag == 2) {
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  synchronized (o2) {
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  try {
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  Thread.sleep(500)  
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  } catch (Exception e) {
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  e.printStackTrace()  
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  synchronized (o1) {
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  System.out.println("线程2获得了两把锁")  
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp   &nbsp   &nbsp  }
 &nbsp   &nbsp  }

 &nbsp   &nbsp  public static void main(String[] argv) {
 &nbsp   &nbsp   &nbsp   &nbsp  MustDeadLock r1 = new MustDeadLock()  
 &nbsp   &nbsp   &nbsp   &nbsp  MustDeadLock r2 = new MustDeadLock()  
 &nbsp   &nbsp   &nbsp   &nbsp  r1.flag = 1  
 &nbsp   &nbsp   &nbsp   &nbsp  r2.flag = 2  
 &nbsp   &nbsp   &nbsp   &nbsp  Thread t1 = new Thread(r1, "t1")  
 &nbsp   &nbsp   &nbsp   &nbsp  Thread t2 = new Thread(r2, "t2")  
 &nbsp   &nbsp   &nbsp   &nbsp  t1.start()  
 &nbsp   &nbsp   &nbsp   &nbsp  t2.start()  
 &nbsp   &nbsp  }
}
...
<img src="https://s0.lgstatic.com/i/image3/M01/0C/16/Ciqah16NrzKAQ0EzAABXlJN0J2Q517.png" alt="">
