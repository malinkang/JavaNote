...
![](https://cdn.malinkang.com/images/currency/202112161102131.png)
...
public  static  void  main(String[]  args)  {
    ...
    BlockingQueue&lt  Object&gt    queue  =  new  ArrayBlockingQueue&lt  &gt  (10)  
  
  Runnable  producer  =  ()  -&gt    {
        while  (true)  {
